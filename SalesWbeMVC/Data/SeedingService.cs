...
using SalesWbeMVC.Models.Enums;

namespace SalesWbeMVC.Data
{
    public class SeedingService
    {
        private SalesWbeMVCContext _context;

        public SeedingService(SalesWbeMVCContext context)
        {
            _context = context;
        }
        ...
        public void seed()
        {
            ...
            Seller s6 = new Seller(6, "Gabriel Black", "black@gmail.com", new DateTime(1978, 4, 4), 10000.0, d2);
            ...
            _context.Seller.AddRange(s1, s2, s4, s4, s5, s6);
